...
ProductListResponse copyWith({  bool? success,
  String? message,
  List<ProductListData>? data,
  Pagination? pagination,
}) => ProductListResponse(  success: success ?? this.success,
...
ProductListData copyWith({  String? id,
  String? name,
  String? description,
  num? price,
  num? stock,
